...
def logo():
    ...
    print("\033[94m│     \033[92m #••_        #           #     #         #    #  #  -   \033[94m   │".center(columns+15))
    print("\033[94m│     \033[92m #     #     #  #      #     #_____#     #  < -  #.  \033[94m   │".center(columns+15))
    print("\033[94m│     \033[92m #     #     #      #  #     #````````#     #  < -  #  \033[94m   │".center(columns+15))
    print("\033[94m│     \033[92m #_-     @ #           # @ #        # @ #  # -    \033[94m   │".center(columns+15))
    print("\033[94m│                              \033[94m          │".center(columns+9))
    print("\033[94m│ \033[95mAuthor : D.N.H.BOYS                    \033[94m│".center(columns+15))
    print("│ \033[95mTool   : Unlimited SMS Bomber          \033[94m│".center(columns+9))
    print("│ \033[95mGitHub : https://github.com/mrerror \033[94m│".center(columns+9))
    print("│ \033[95mCoder  : Abir.               \033[37mV3.0 \033[94m│".center(columns+15))
    print("\033[94m└────────────────────────────────────────┘".center(columns+5))
